...
// Retornar o token JWT
  ...
  // No methods, a função não pode ser em forma de arrow function, se for não funciona.
usuarioSchema.methods.getJwtToken = function () {
  // .sign(payload: JSON, secretOrPrivateKey, [options, callback]) - usado para passar um valor em formato JSON para o token
...
// Comparar a senha inserida no login com a senha criptografada
  // bcrypt - usado para comparar a senha digitada com a criptografada. É uma solicitação assincrona.
    ...
    // A função não pode ser em forma de arrow function, se for não funciona.
